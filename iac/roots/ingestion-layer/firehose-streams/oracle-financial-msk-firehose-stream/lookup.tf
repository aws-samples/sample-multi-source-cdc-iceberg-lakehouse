...
data "aws_ssm_parameter" "msk_ingest_oracle_financial_transactions_topic_name" {
...
locals {
  ...
  TOPIC_NAME            = data.aws_ssm_parameter.msk_ingest_oracle_financial_transactions_topic_name.value
