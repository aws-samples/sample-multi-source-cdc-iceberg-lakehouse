...
output "firehose_role_arn" {
  ...
  value       = module.msk_firehose_ingestion.firehose_role_arn
}

output "glue_table_name" {
  description = "Name of the Oracle Glue table"
  value       = module.oracle_financial_transactions_table.table_name
}
