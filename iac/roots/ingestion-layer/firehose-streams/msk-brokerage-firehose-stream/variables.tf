...
variable "MSK_BROKERAGE_TOPIC_NAME_PARAMETER" {
  type        = string
  description = "MSK topic name parameter for brokerage data"
}
...
variable "MSK_BROKERAGE_TABLE_NAME" {
  description = "MSK brokerage table name for Glue catalog"
  type        = string
}
