...
data "aws_ssm_parameter" "msk_ingest_aurora_brokerage_transactions_topic_name" {
...
locals {
  ...
  TOPIC_NAME            = data.aws_ssm_parameter.msk_ingest_aurora_brokerage_transactions_topic_name.value
