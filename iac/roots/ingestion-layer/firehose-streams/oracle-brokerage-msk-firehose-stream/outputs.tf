...
output "firehose_delivery_stream_name" {
  ...
  value       = module.oracle_firehose_ingestion.firehose_delivery_stream_name
}

output "firehose_delivery_stream_arn" {
  description = "ARN of the Firehose delivery stream"
  value       = module.oracle_firehose_ingestion.firehose_delivery_stream_arn
}

output "firehose_role_arn" {
  description = "ARN of the IAM role used by Firehose"
  value       = module.oracle_firehose_ingestion.firehose_role_arn
}

output "glue_table_name" {
  description = "Name of the Glue table"
  value       = module.oracle_brokerage_transactions_table.table_name
}
