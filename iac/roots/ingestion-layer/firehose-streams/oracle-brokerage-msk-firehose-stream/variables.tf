...
variable "ORACLE_BROKERAGE_TOPIC_NAME_PARAMETER" {
  type        = string
  description = "MSK topic name for Oracle brokerage data parameter"
}
...
variable "ORACLE_BROKERAGE_TABLE_NAME" {
  description = "Oracle brokerage table name for Glue catalog"
  type        = string
}
