...
data "aws_ssm_parameter" "cockroach_brokerage_topic_name" {
  name = "/${var.APP}/${var.ENV}/${var.COCKROACH_BROKERAGE_TOPIC_NAME_PARAMETER}"
}
...
locals {
  ...
  TOPIC_NAME              = data.aws_ssm_parameter.cockroach_brokerage_topic_name.value
